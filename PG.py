...
plt.plot(range(k),V_hist[0:k:1,0,0,2,1])
...
r = 4
c = 0
plt.plot(range(k),theta_hist[0:k:1,0,0,r,c][:,0],label = 'U')
plt.plot(range(k),theta_hist[0:k:1,0,0,r,c][:,1],label = 'D')
plt.plot(range(k),theta_hist[0:k:1,0,0,r,c][:,2],label = 'R')
plt.plot(range(k),theta_hist[0:k:1,0,0,r,c][:,3],label = 'L')
plt.plot(range(k),theta_hist[0:k:1,0,0,r,c][:,4],label = 'e1')
plt.plot(range(k),theta_hist[0:k:1,0,0,r,c][:,5],label = 'e2')
plt.legend()
# #%%
# state = (0,0,0,0)
# temp = 0
# for i in range(100):
#     state_hist, action_hist, G_t_hist, gamma_hist = one_trajectroy(state,csrl,theta,T+2000)
#     temp = temp + G_t_hist[0]
# print(temp/100)